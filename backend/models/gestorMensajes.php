...
class MensajesModel{
	...
	public function mostrarMensajesModel($tabla){
		...
		$stmt = Conexion::conectar()->prepare("SELECT id, nombre, identificacion, telefono, email, profesion, perfil, cargo, vinculacion, dependencia, unidad, extension, fecha FROM $tabla ORDER BY fecha DESC"); 
