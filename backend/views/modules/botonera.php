	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
			...
			<ul class="nav navbar">
				...
				<li><a href="articulos">FORMULARIO<span class="glyphicon glyphicon-new-window"></span></a></li>
				...
				echo '<li><a href="suscriptores">SOLICITUDES<span class="glyphicon glyphicon-new-window"></span></a></li>';
