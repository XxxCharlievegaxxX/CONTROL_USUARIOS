...
$(".leerMensaje").click(function(){
	...
	nombre = $("#"+id).children("input").val();
	identificacion = $("#"+id).children("input").val();
	telefono = $("#"+id).children("input").val();
	profesion = $("#"+id).children("input").val();
	perfil = $("#"+id).children("input").val();
	cargo = $("#"+id).children("input").val();
	vinculacion = $("#"+id).children("input").val();
	dependencia = $("#"+id).children("input").val();
	unidad = $("#"+id).children("input").val();
	extension = $("#"+id).children("input").val();
